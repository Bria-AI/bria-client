...
class StatusAPI:
    ...
    async def wait_for_status_request(self, request_id: str, timeout: int = 120, interval: int = 2, delay: int = 0) -> StatusAPIResponse:
        """
        ...
        Args:
            ...
            `delay: int` - The delay in seconds before the first request
