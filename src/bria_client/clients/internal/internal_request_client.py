...
from bria_client.engines.internal.internal_request_engine import InternalRequestEngine
...
class InternalRequestClient(BriaBackend):
    def __init__(
        ...
        engine = InternalRequestEngine(base_url=base_url, api_token_ctx=api_token_ctx, jwt_token_ctx=jwt_token_ctx, retry=retry)
