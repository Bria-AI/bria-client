...
from bria_client.toolkit.models import VideoUploadResult
...
class BriaSyncClient(BaseBriaClient):
    ...
    def request_video_upload(self, media_type: str | None = None, headers: dict | None = None, **kwargs) -> VideoUploadResult:
        """
